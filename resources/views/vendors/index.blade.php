...
<main>
  ...
  <label for="tab1">Vendor terverifikasi ({{$verifiedCount->verifiedCount}})</label>
  ...
  <section id="content1">
   ...
   <!-- table start -->
    ...
    <tr>
      ...
      <td>{{ $vendor->JumlahLot }} Kendaraan</td>
      <td>{{ $vendor->TotalPembayaran }}</td>
      <td>{{ $vendor->vendor_membership }}</td>      
    </tr>
  @endforeach
