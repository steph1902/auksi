<?php /* C:\Users\devih\laravelproject\auksi\resources\views/lots/index.blade.php */ ?>
<!DOCTYPE html>
<html lang="en">
...
<main>
  ...
  <hr><hr>
  <a href="<?php echo e(url('lots/create')); ?>">
  ...
  <section id="content1">
   ...
   <!-- table start -->
    ...
    <tr>
      <td><?php echo e($lot->lot_name); ?></td>
      <td><?php echo e($lot->vendor_name); ?></td>
      

      
        <?php if($lot->lot_appraisal==0): ?>
          <td>Belum Appraisal</td>
        <?php elseif($lot->lot_appraisal==1): ?>    
          <td>Lulus Appraisal</td>
        <?php endif; ?>
      

      <td>IDR <?php echo e($lot->lot_price); ?></td>      
    </tr>
